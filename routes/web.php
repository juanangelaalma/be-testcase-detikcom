...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/books/{book:id}/edit', [BookController::class, 'editBookById'])->name('book.edit');
    Route::put('/books/{book:id}/update', [BookController::class, 'updateBookById'])->name('book.update');
